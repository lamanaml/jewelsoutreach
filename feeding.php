            ...
            <div class="card h-100" style="border:0px">
              <div class="card-body"  >
                <h2 class="section-heading text-uppercase">Jewels Feeding Friends</h2>
                  <p class="card-text">It our mission to provide a solution for the food insecurities in our community. Durham, along with so many other cities, is experiencing unprecedented gentrification, which can unfortunately leave many lower income families displaced and in a state of food poverty. </p>
